...
export default function Ventures() {
  ...
  /*
   * Keep the existing visual ring on phones,
   * but only run continuous rotation on fine-pointer devices.
   * This avoids an unnecessary infinite animation on mobile.
   */
